...
<body class="min-h-screen flex flex-col bg-[#F5F5F7] text-slate-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <span class="px-2.5 py-1 text-xs font-semibold rounded-full bg-amber-100 text-amber-800 uppercase tracking-wider">
                        {{ $user->role }}
                    </span>
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Welcome Banner -->
        <div class="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-6 sm:p-8 text-white shadow-sm mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold tracking-tight">Selamat Datang, {{ $user->nama }}!</h1>
                    <p class="text-orange-100 mt-1 text-sm sm:text-base">Anda berhasil masuk ke Sistem Penjadwalan Kelas Elips Academy sebagai <strong>Admin</strong>.</p>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm mb-6">
            <div class="flex items-start gap-4">
                <div class="w-12 h-12 rounded-xl bg-orange-100 text-brand-orange flex items-center justify-center shrink-0">
                    <span class="material-symbols-outlined text-2xl">event_available</span>
                </div>
                <div class="flex-1">
                    <h2 class="text-lg font-bold text-slate-900">Dashboard Operasional Admin (Placeholder)</h2>
                    <p class="text-sm text-slate-600 mt-1">
                        Modul autentikasi telah aktif dan berhasil mengidentifikasi hak akses Anda. Modul antarmuka jadwal operasional kelas akan diintegrasikan pada issue berikutnya.
                    </p>
                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                        <div class="p-3 rounded-lg bg-slate-50 border border-slate-100">
                            ...
                            <span class="font-semibold text-slate-800 ml-1">Jadwal Kelas & Operasional</span>
                        </div>
                        <div class="p-3 rounded-lg bg-slate-50 border border-slate-100">
                            <span class="text-slate-500 font-medium">Status Akun:</span>
                            <span class="font-semibold text-emerald-600 ml-1">Terverifikasi & Aktif</span>
                        </div>
                    </div>
                </div>
            </div>
