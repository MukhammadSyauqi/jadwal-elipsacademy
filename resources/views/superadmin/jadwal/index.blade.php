                    ...
                    <table class="w-full text-left border-collapse" id="table-jadwal">
                        <thead>
                            <tr class="bg-surface-container-low text-ink-muted text-[11px] uppercase tracking-wider border-b border-hairline">
                                ...
                                <th class="py-3 px-4 font-bold">Jenis & Mode</th>
                                ...
                                <tr class="hover:bg-surface-pearl/80 transition-colors group">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex flex-col gap-1 items-start">
                                            ...
                                            @if(($item->mode_kelas ?? 'offline') === 'online')
                                                <span class="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-bold bg-sky-50 text-sky-700 border border-sky-200">
                                                    <span class="material-symbols-outlined text-[12px]">videocam</span>
                                                    Online
                                                </span>
                                            @else
                                                <span class="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-bold bg-amber-50 text-amber-800 border border-amber-200">
