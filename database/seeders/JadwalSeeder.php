...
class JadwalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $jadwalList = [
            ...
            // Cabang 3: Gubeng - HARI INI
            [
                'cabang_id' => 3,
                'program_id' => 1,
                'tentor_id' => 1,
                'nama_kelas' => 'MO-' . \Carbon\Carbon::parse($today)->format('dm') . '-01',
                'jenis_kelas' => 'private',
                'mode_kelas' => 'offline',
                'tanggal' => $today,
                'jam_mulai' => '09:00:00',
                ...
                'pertemuan' => 1,
                'status' => 'selesai',
                'catatan' => 'Kelas Microsoft Office Cabang Gubeng',
            ],
            [
                'cabang_id' => 3,
                'program_id' => 2,
                'tentor_id' => 2,
                'nama_kelas' => 'WP-' . \Carbon\Carbon::parse($today)->format('dm') . '-01',
                'jenis_kelas' => 'rombel',
                'mode_kelas' => 'offline',
                'tanggal' => $today,
                'jam_mulai' => '13:00:00',
            ...
            [
                ...
                'program_id' => 3,
                'tentor_id' => 3,
                'nama_kelas' => 'GD-' . \Carbon\Carbon::parse($today)->format('dm') . '-01',
                'jenis_kelas' => 'business',
                'mode_kelas' => 'online',
                'tanggal' => $today,
                'jam_mulai' => '15:30:00',
